...
Click the link for the link:https://github.com/plentymarkets/plugin-hello-world2[github repository].
...

{
    ...
    "namespace": "MyFirstView", <3>
    "author": "Your name", <4>
    "type": "backend", <5>
    "serviceProvider": "MyFirstView\\Providers\\MyFirstViewServiceProvider" <6>
}
----
<1> This is the name of our plugin. This is also how it will be displayed in the repository.
<2> A description for our plugin
